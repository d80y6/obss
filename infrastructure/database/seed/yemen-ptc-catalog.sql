-- =============================================================================
-- Yemen PTC (Public Telecommunication Corporation) - Product & Service Catalog
-- Telecom OSS/BSS Platform Seed Data
-- =============================================================================
-- This script inserts the complete residential and business service catalog
-- for Yemen PTC. It is idempotent and safe to run multiple times.
-- =============================================================================
...
-- ── Schema Extensions for Arabic Localization ─────────────────────────────
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'catalog' AND table_name = 'categories' AND column_name = 'name_ar') THEN
        ALTER TABLE catalog.categories ADD COLUMN name_ar character varying(200);
        ALTER TABLE catalog.categories ADD COLUMN description_ar character varying(1000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'catalog' AND table_name = 'products' AND column_name = 'name_ar') THEN
        ALTER TABLE catalog.products ADD COLUMN name_ar character varying(200);
        ALTER TABLE catalog.products ADD COLUMN description_ar character varying(2000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'catalog' AND table_name = 'offers' AND column_name = 'name_ar') THEN
        ALTER TABLE catalog.offers ADD COLUMN name_ar character varying(200);
        ALTER TABLE catalog.offers ADD COLUMN description_ar character varying(2000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'service_catalog' AND table_name = 'service_categories' AND column_name = 'name_ar') THEN
        ALTER TABLE service_catalog.service_categories ADD COLUMN name_ar character varying(200);
        ALTER TABLE service_catalog.service_categories ADD COLUMN description_ar character varying(2000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'service_catalog' AND table_name = 'service_specifications' AND column_name = 'name_ar') THEN
        ALTER TABLE service_catalog.service_specifications ADD COLUMN name_ar character varying(200);
        ALTER TABLE service_catalog.service_specifications ADD COLUMN description_ar character varying(2000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'service_catalog' AND table_name = 'service_spec_characteristics' AND column_name = 'name_ar') THEN
        ALTER TABLE service_catalog.service_spec_characteristics ADD COLUMN name_ar character varying(200);
        ALTER TABLE service_catalog.service_spec_characteristics ADD COLUMN description_ar character varying(2000);
    END IF;
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'crm' AND table_name = 'customer_segments' AND column_name = 'name_ar') THEN
        ALTER TABLE crm.customer_segments ADD COLUMN name_ar character varying(200);
        ALTER TABLE crm.customer_segments ADD COLUMN description_ar character varying(1000);
    END IF;
END $$;
...
-- =========================================================================
INSERT INTO crm.customer_segments (id, tenant_id, name, name_ar, description, description_ar, criteria, priority, is_active, created_at, updated_at)
VALUES
(
...
-- =========================================================================
INSERT INTO service_catalog.service_categories (id, tenant_id, name, name_ar, description, description_ar, parent_category_id, lifecycle_status, version, created_at, updated_at)
VALUES
(
...
INSERT INTO service_catalog.service_specifications (id, tenant_id, name, name_ar, description, description_ar, brand, version, lifecycle_status, is_bundle, created_at, updated_at)
VALUES (
...
INSERT INTO service_catalog.service_spec_characteristics (id, service_specification_id, name, name_ar, description, description_ar, value_type, configurable, is_required, sort_order)
VALUES
...
('a0000000-0000-4000-a000-000000000203', 'a0000000-0000-4000-a000-000000000100', 'Mobile Data', 'البيانات المتنقلة', 'Included 4G mobile data in GB', 'البيانات المتنقلة عبر الجيل الرابع المضمنة بالجيجابايت', 'number', false, true, 3);

INSERT INTO service_catalog.service_spec_characteristic_values (id, characteristic_id, value, unit_of_measure, is_default)
VALUES
...
('a0000000-0000-4000-a000-000000000207', 'a0000000-0000-4000-a000-000000000101', 'Equipment Vendor', 'مورد المعدات', 'OLT/ONT equipment vendor', 'مورد معدات OLT/ONT', 'string', false, false, 4);
...
('a0000000-0000-4000-a000-000000000209', 'a0000000-0000-4000-a000-000000000102', 'Call Type', 'نوع المكالمة', 'Types of calls included', 'أنواع المكالمات المضمنة', 'string', false, true, 2);

INSERT INTO service_catalog.service_spec_characteristic_values (id, characteristic_id, value, is_default)
VALUES
...
('a0000000-0000-4000-a000-000000000220', 'a0000000-0000-4000-a000-000000000103', 'Technology', 'التقنية', 'DSL technology variant', 'نوع تقنية DSL', 'string', false, true, 2);
...
('a0000000-0000-4000-a000-000000000223', 'a0000000-0000-4000-a000-000000000104', 'Technology', 'التقنية', 'Mobile network technology', 'تقنية الشبكة المتنقلة', 'string', false, true, 3);
...
('a0000000-0000-4000-a000-000000000226', 'a0000000-0000-4000-a000-000000000105', 'CPE Included', 'جهاز CPE مضمن', 'Whether CPE equipment is included', 'ما إذا كان جهاز CPE مضمنًا', 'boolean', false, true, 3);
...
INSERT INTO service_catalog.service_spec_characteristics (id, service_specification_id, name, name_ar, description, description_ar, value_type, configurable, is_required, sort_order)
VALUES
('a0000000-0000-4000-a000-000000000227', 'a0000000-0000-4000-a000-000000000106', 'Feature Type', 'نوع الخدمة', 'Supplementary service feature', 'خدمة إضافية', 'string', true, true, 1);
...
INSERT INTO service_catalog.service_spec_characteristics (id, service_specification_id, name, name_ar, description, description_ar, value_type, configurable, is_required, sort_order)
VALUES
('a0000000-0000-4000-a000-000000000228', 'a0000000-0000-4000-a000-000000000107', 'Rental Type', 'نوع الإيجار', 'Monthly line rental type', 'نوع الإيجار الشهري للخط', 'string', true, true, 1);
...
INSERT INTO service_catalog.service_spec_characteristics (id, service_specification_id, name, name_ar, description, description_ar, value_type, configurable, is_required, sort_order)
VALUES
('a0000000-0000-4000-a000-000000000229', 'a0000000-0000-4000-a000-000000000108', 'Session Duration', 'مدة الجلسة', 'Maximum WiFi session duration', 'الحد الأقصى لمدة جلسة الواي فاي', 'number', false, true, 1);
...
('a0000000-0000-4000-a000-000000000243', 'a0000000-0000-4000-a000-000000000110', 'Support Response', 'وقت الاستجابة للدعم', 'SLA support response time in hours', 'وقت الاستجابة للدعم الفني حسب SLA بالساعات', 'number', false, false, 4);
...
('a0000000-0000-4000-a000-000000000247', 'a0000000-0000-4000-a000-000000000111', 'Traffic Type', 'نوع الحركة', 'Type of internet traffic', 'نوع حركة الإنترنت', 'string', false, true, 4);

INSERT INTO service_catalog.service_spec_characteristic_values (id, characteristic_id, value, is_default)
VALUES
('a0000000-0000-4000-a000-000000000239', 'a0000000-0000-4000-a000-000000000245', '1:1', true),
('a0000000-0000-4000-a000-000000000248', 'a0000000-0000-4000-a000-000000000246', '99.99', 'percent', true),
...
('a0000000-0000-4000-a000-000000000251', 'a0000000-0000-4000-a000-000000000112', 'Topology', 'طوبولوجيا الشبكة', 'Network topology type', 'نوع طوبولوجيا الشبكة', 'string', true, true, 2);
...
('a0000000-0000-4000-a000-000000000255', 'a0000000-0000-4000-a000-000000000113', 'Capacity', 'السعة', 'Circuit capacity in E1 or STM units', 'سعة الدائرة بوحدات E1 أو STM', 'number', true, true, 2);
...
('a0000000-0000-4000-a000-000000000260', 'a0000000-0000-4000-a000-000000000114', 'Signaling Type', 'نوع الإشارات', 'PRI signaling protocol', 'بروتوكول إشارات PRI', 'string', false, true, 2);
...
('a0000000-0000-4000-a000-000000000263', 'a0000000-0000-4000-a000-000000000115', 'Concurrent Calls', 'المكالمات المتزامنة', 'Maximum concurrent call capacity', 'الحد الأقصى للمكالمات المتزامنة', 'number', true, false, 2);
...
('a0000000-0000-4000-a000-000000000265', 'a0000000-0000-4000-a000-000000000116', 'IPv6 Prefix', 'بادئة IPv6', 'IPv6 prefix length if applicable', 'طول بادئة IPv6 إن وجد', 'string', true, false, 2);
...
('a0000000-0000-4000-a000-000000000267', 'a0000000-0000-4000-a000-000000000117', 'Technology', 'التقنية', 'Wireless technology generation', 'تقنية الجيل اللاسلكي', 'string', false, true, 2);
...
('a0000000-0000-4000-a000-000000000272', 'a0000000-0000-4000-a000-000000000118', 'Bandwidth', 'سعة النطاق', 'Monthly bandwidth allowance in TB', 'حصة النطاق الشهرية بالتيرابايت', 'number', true, true, 4);
...
('a0000000-0000-4000-a000-000000000275', 'a0000000-0000-4000-a000-000000000119', 'Storage', 'التخزين', 'SSD storage in GB', 'مساحة تخزين SSD بالجيجابايت', 'number', true, true, 3);
...
('a0000000-0000-4000-a000-000000000278', 'a0000000-0000-4000-a000-000000000120', 'Bandwidth', 'النطاق', 'Included bandwidth in Mbps', 'النطاق المضمن بالميغابت', 'number', true, true, 3);
...
('a0000000-0000-4000-a000-000000000284', 'a0000000-0000-4000-a000-000000000121', 'Domains Supported', 'النطاقات المدعومة', 'Number of hosted domains', 'عدد النطاقات المستضافة', 'number', true, true, 3);
...
('a0000000-0000-4000-a000-000000000286', 'a0000000-0000-4000-a000-000000000122', 'Registration Period', 'فترة التسجيل', 'Registration duration in years', 'مدة التسجيل بالسنوات', 'number', true, true, 2);
...
('a0000000-0000-4000-a000-000000000293', 'a0000000-0000-4000-a000-000000000123', 'SLA Uptime', 'نسبة تشغيل SLA', 'Service level agreement uptime', 'نسبة تشغيل اتفاقية مستوى الخدمة', 'number', false, true, 3);
...
('a0000000-0000-4000-a000-000000000296', 'a0000000-0000-4000-a000-000000000293', '99.99', 'percent', true)
ON CONFLICT DO NOTHING;

-- =========================================================================
-- PART 5: Catalog Categories
-- =========================================================================
INSERT INTO catalog.categories (id, tenant_id, name, name_ar, description, description_ar, parent_category_id, is_active, lifecycle_status, sort_order, created_at, updated_at, version)
VALUES
...
INSERT INTO catalog.products (id, tenant_id, name, name_ar, description, description_ar, category_id, product_type, is_active, is_shippable, taxable, lifecycle_status, product_number, created_at, updated_at)
VALUES
-- Super Shamel Bundle
...
INSERT INTO catalog.offers (id, tenant_id, name, name_ar, description, description_ar, offer_type, is_active, is_contract, billing_period, tax_inclusive, sort_order, created_at, updated_at)
VALUES (
...
INSERT INTO catalog.offer_pricings (id, offer_id, pricing_type, currency, recurring_price, one_time_price, usage_price, unit_of_measure, is_active, name, description)
VALUES (
...
INSERT INTO catalog.offer_pricings (id, offer_id, pricing_type, currency, recurring_price, one_time_price, usage_price, unit_of_measure, is_active, name)
VALUES
...
-- =========================================================================
INSERT INTO catalog.product_offers (id, product_id, offer_id, is_primary, is_required, created_at)
SELECT * FROM (VALUES
-- Super Shamel Bundle
...
WHERE NOT EXISTS (SELECT 1 FROM catalog.product_offers WHERE id = v.column1);

-- =========================================================================
-- PART 9: Super Shamel Bundle - Component Offerings
-- =========================================================================
INSERT INTO catalog.bundled_product_offerings (id, offer_id, bundled_offer_id, name, quantity, referral_type)
VALUES (
...
INSERT INTO catalog.catalog_product_specifications (id, tenant_id, name, description, brand, version, product_number, lifecycle_status, service_specification_id, created_at, updated_at)
SELECT * FROM (VALUES
...
WHERE NOT EXISTS (SELECT 1 FROM catalog.catalog_product_specifications WHERE id = v.column1);
