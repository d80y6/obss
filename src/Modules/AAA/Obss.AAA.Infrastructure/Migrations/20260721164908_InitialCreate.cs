        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nas_ip_address = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: false),
                    nas_secret = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    nas_type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_nas_devices", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "radius_sessions",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    tenant_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    session_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    nas_id = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false),
                    username = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    framed_ip_address = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
                    called_station_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    calling_station_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    acct_session_time = table.Column<long>(type: "bigint", nullable: false),
                    input_octets = table.Column<long>(type: "bigint", nullable: false),
                    output_octets = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_radius_sessions", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_nas_devices_ip",
                table: "nas_devices",
                column: "nas_ip_address");

            migrationBuilder.CreateIndex(
                name: "ix_nas_devices_tenant_name",
                table: "nas_devices",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_radius_sessions_framed_ip",
                table: "radius_sessions",
                column: "framed_ip_address");

            migrationBuilder.CreateIndex(
                name: "ix_radius_sessions_session_id",
                table: "radius_sessions",
                column: "session_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_radius_sessions_username",
                table: "radius_sessions",
                column: "username");
        }
