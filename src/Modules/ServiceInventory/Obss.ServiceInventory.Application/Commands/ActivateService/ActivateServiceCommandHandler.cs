...
public sealed class ActivateServiceCommandHandler : IRequestHandler<ActivateServiceCommand, Result<ServiceDto>>
{
    ...
    public async Task<Result<ServiceDto>> Handle(ActivateServiceCommand request, CancellationToken cancellationToken)
    {
