...
namespace Obss.ServiceInventory.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    related_party_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    related_party_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    related_party_role = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
