...
public sealed class CompleteProductOrderItemCommandHandler(IProductOrderRepository repository)
    : IRequestHandler<CompleteProductOrderItemCommand, Result>
{
    public async Task<Result> Handle(CompleteProductOrderItemCommand request, CancellationToken cancellationToken)
    {
