...
public sealed class Resume4GCommandHandler : IRequestHandler<Resume4GCommand, Result<LifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public Resume4GCommandHandler(
    ...
    public async Task<Result<LifecycleResult>> Handle(Resume4GCommand request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new LifecycleResult(
            correlationId,
            "Resumed",
            "4G service resumed successfully.",
            "تم استئناف خدمة 4G بنجاح.",
            jobId));
    }
}
