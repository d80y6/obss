...
public sealed class DeactivateSupplementaryServiceCommandValidator : AbstractValidator<DeactivateSupplementaryServiceCommand>
{
    public DeactivateSupplementaryServiceCommandValidator()
    {
        RuleFor(x => x.OrderId)
