...
public sealed class UpdateSupplementaryServiceCommandValidator : AbstractValidator<UpdateSupplementaryServiceCommand>
{
    public UpdateSupplementaryServiceCommandValidator()
    {
        RuleFor(x => x.OrderId)
