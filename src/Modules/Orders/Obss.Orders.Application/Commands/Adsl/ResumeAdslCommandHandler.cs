...
public sealed class ResumeAdslCommandHandler : IRequestHandler<ResumeAdslCommand, Result<AdslLifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ResumeAdslCommandHandler(
    ...
    public async Task<Result<AdslLifecycleResult>> Handle(ResumeAdslCommand request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new AdslLifecycleResult(
            correlationId,
            "Resumed",
            "ADSL service resumed successfully.",
            "تم استئناف خدمة ADSL بنجاح.",
            jobId));
    }
}
