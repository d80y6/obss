...
public sealed class ResumeHatifFawtaraCommandHandler : IRequestHandler<ResumeHatifFawtaraCommand, Result<HatifFawtaraLifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ResumeHatifFawtaraCommandHandler(
    ...
    public async Task<Result<HatifFawtaraLifecycleResult>> Handle(ResumeHatifFawtaraCommand request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new HatifFawtaraLifecycleResult(
            correlationId,
            "Resumed",
            "Hatif Fawtara service resumed successfully.",
            "تم استئناف خدمة هاتفي فوترة بنجاح.",
            jobId));
    }
}
