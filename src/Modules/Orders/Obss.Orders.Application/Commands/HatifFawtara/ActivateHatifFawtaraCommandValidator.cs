...
public sealed class ActivateHatifFawtaraCommandValidator : AbstractValidator<ActivateHatifFawtaraCommand>
{
    public ActivateHatifFawtaraCommandValidator()
    {
        RuleFor(x => x.OrderId)
        ...
        RuleFor(x => x.DepositAmount)
            .GreaterThanOrEqualTo(0).WithMessage("Deposit amount must be zero or greater.");
