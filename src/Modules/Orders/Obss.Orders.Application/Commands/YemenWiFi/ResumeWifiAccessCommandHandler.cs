...
public sealed class ResumeWifiAccessCommandHandler : IRequestHandler<ResumeWifiAccessCommand, Result<LifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ResumeWifiAccessCommandHandler(
    ...
    public async Task<Result<LifecycleResult>> Handle(ResumeWifiAccessCommand request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new LifecycleResult(
            correlationId,
            "Resumed",
            "Yemen WiFi service resumed successfully.",
            "تم استئناف خدمة يمن واي فاي بنجاح.",
            jobId,
            null));
    }
}
