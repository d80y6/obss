...
public sealed class TransferDomainCommandHandler : IRequestHandler<TransferDomainCommand, Result<DomainLifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public TransferDomainCommandHandler(
    ...
    public async Task<Result<DomainLifecycleResult>> Handle(TransferDomainCommand request, CancellationToken cancellationToken)
    {
