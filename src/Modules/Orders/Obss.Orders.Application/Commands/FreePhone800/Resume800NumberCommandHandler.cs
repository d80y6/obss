...
public sealed class Resume800NumberCommandHandler : IRequestHandler<Resume800NumberCommand, Result<FreePhone800LifecycleResult>>
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly IRepository<ProvisioningJob> _provisioningJobRepository;
    private readonly IUnitOfWork _unitOfWork;

    public Resume800NumberCommandHandler(
    ...
    public async Task<Result<FreePhone800LifecycleResult>> Handle(Resume800NumberCommand request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new FreePhone800LifecycleResult(
            correlationId,
            "Resumed",
            "800 free phone number resumed successfully.",
            "تم استئناف الرقم المجاني 800 بنجاح.",
            jobId));
    }
}
