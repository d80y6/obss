...
namespace Obss.Orders.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260710220617_RenameAndAddTmf622Resources")]
    partial class RenameAndAddTmf622Resources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("BillingAccountHref")
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("ProductOfferingQualificationHref")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("product_offering_qualification_href");

                    b.Property<Guid?>("ProductOfferingQualificationId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_offering_qualification_id");

                    b.Property<string>("QuoteHref")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("quote_href");
            ...
            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_order_items");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_product_order_items_order_id");

                    b.ToTable("product_order_items", (string)null);
                });

            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderItemRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<Guid>("ProductOrderItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_order_item_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_order_item_relationships");

                    b.ToTable("product_order_item_relationships", (string)null);
                });

            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderMilestone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_order_milestones");

                    b.HasIndex("ProductOrderId")
                        .HasDatabaseName("ix_product_order_milestones_product_order_id");

                    b.ToTable("product_order_milestones", (string)null);
                });

            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_order_payments");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_product_order_payments_order_id");

                    b.ToTable("product_order_payments", (string)null);
                });
            ...
            modelBuilder.Entity("Obss.Orders.Domain.Entities.OrderFulfillment", b =>
                {
                    b.HasOne("Obss.Orders.Domain.Entities.ProductOrder", null)
                        .WithOne("Fulfillment")
                        .HasForeignKey("Obss.Orders.Domain.Entities.OrderFulfillment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_fulfillments_product_orders_order_id");
                });
                    ...
                    b.OwnsOne("Obss.SharedKernel.Domain.ValueObjects.Address", "BillingAddress", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_product_orders_product_orders_id");
                        });
            ...
            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderItem", b =>
                {
                    b.HasOne("Obss.Orders.Domain.Entities.ProductOrder", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_order_items_product_orders_order_id");
                });
            ...
            modelBuilder.Entity("Obss.Orders.Domain.Entities.ProductOrderPayment", b =>
                {
                    b.HasOne("Obss.Orders.Domain.Entities.ProductOrder", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_order_payments_product_orders_order_id");
                });
