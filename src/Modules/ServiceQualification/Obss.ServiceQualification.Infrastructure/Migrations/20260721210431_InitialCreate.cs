        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    technology_type = table.Column<string>(type: "text", nullable: true),
                    explanation_ar = table.Column<string>(type: "text", nullable: true),
                    estimated_installation_time_days = table.Column<int>(type: "integer", nullable: true),
