...
public abstract class ProvisioningIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected ProvisioningIntegrationTests()
    {
    ...
    protected ProvisioningDbContext CreateDbContext()
    {
        ...
        var context = new ProvisioningDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(ProvisioningDbContext context)
    {
