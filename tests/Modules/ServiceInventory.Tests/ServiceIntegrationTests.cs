...
public abstract class ServiceIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected ServiceIntegrationTests()
    {
    ...
    protected ServiceDbContext CreateDbContext()
    {
        ...
        var context = new ServiceDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(ServiceDbContext context)
    {
