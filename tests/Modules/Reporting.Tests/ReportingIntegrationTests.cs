...
public abstract class ReportingIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected ReportingIntegrationTests()
    {
    ...
    protected ReportDbContext CreateDbContext()
    {
        ...
        var context = new ReportDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(ReportDbContext context)
    {
