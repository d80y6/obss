...
public abstract class IamIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected IamIntegrationTests()
    {
    ...
    protected IamDbContext CreateDbContext()
    {
        ...
        var context = new IamDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(IamDbContext context)
    {
