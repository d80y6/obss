...
public abstract class NetworkIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected NetworkIntegrationTests()
    {
    ...
    protected NetworkDbContext CreateDbContext()
    {
        ...
        var context = new NetworkDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(NetworkDbContext context)
    {
