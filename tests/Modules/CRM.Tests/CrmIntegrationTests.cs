...
public abstract class CrmIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected CrmIntegrationTests()
    {
    ...
    protected CrmDbContext CreateDbContext()
    {
        ...
        var context = new CrmDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(CrmDbContext context)
    {
