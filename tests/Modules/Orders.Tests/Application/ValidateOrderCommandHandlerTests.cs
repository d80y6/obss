...
public class ValidateProductOrderCommandHandlerTests
{
    private readonly IProductOrderRepository _orderRepository;
    private readonly OrderValidationService _validationService;
    private readonly ValidateProductOrderCommandHandler _handler;

    public ValidateProductOrderCommandHandlerTests()
    {
        ...
        _handler = new ValidateProductOrderCommandHandler(_orderRepository, _validationService);
    }
    ...
    public async Task Handle_ShouldReturnValidationResult_WhenOrderExists()
    {
        ...
        var result = await _handler.Handle(
            new ValidateProductOrderCommand(order.Id), CancellationToken.None);
    ...
    public async Task Handle_WhenOrderNotFound_ShouldReturnNotFound()
    {
        ...
        var result = await _handler.Handle(
            new ValidateProductOrderCommand(orderId), CancellationToken.None);
