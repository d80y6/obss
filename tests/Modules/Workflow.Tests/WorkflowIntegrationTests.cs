...
public abstract class WorkflowIntegrationTests : IAsyncLifetime
{
    private readonly PostgreSqlContainer _container;

    protected WorkflowIntegrationTests()
    {
    ...
    protected WorkflowDbContext CreateDbContext()
    {
        ...
        var context = new WorkflowDbContext(options, currentTenant, domainEventDispatcher);
        context.Database.EnsureCreated();
        return context;
    }

    protected static IUnitOfWork CreateUnitOfWork(WorkflowDbContext context)
    {
